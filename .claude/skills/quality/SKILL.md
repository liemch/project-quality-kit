...
description: >
  ...
  headed | observe | ui | qc-import | qc-implement | qc-coverage | qc-codegen |
  qc-run | add-domain | status | ai-review.
---
...
| implement TC / sheet / P1 / Pass/Fail hệ thống | `qc-implement` | [`quality-qc-implement`](../quality-qc-implement/SKILL.md) |
| coverage / dashboard / tiến độ TC | `qc-coverage` | [`quality-qc-coverage`](../quality-qc-coverage/SKILL.md) |
| sinh stub từ catalog / codegen | `qc-codegen` | [`quality-qc-codegen`](../quality-qc-codegen/SKILL.md) |
| chạy lại theo TC / sheet (đã implement) | `qc-run` | [`quality-qc-run`](../quality-qc-run/SKILL.md) |
...
| AI review CI | `ai-review` | [`quality-ai-review`](../quality-ai-review/SKILL.md) |
